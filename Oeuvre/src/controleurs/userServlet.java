	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		protected void processusTraiteRequete(HttpServletRequest request,
			...
			if (AJOUT_OEUVRE.equals(actionName)) {
	            ...
	            //Atttributs utilisés pour savoir si il faut ajouter ou modifier le stage
			}
			else if(SAISIE_OEUVRE.equals(actionName))
			{
				...
				{
					System.out.println("Oeuvre non rÈservable");
				...
				// mettre ‡ la lettre R
				Oeuvre o = new Oeuvre();
				o.OeuvreReservÈe(Integer.parseInt(id_oeuvre));
